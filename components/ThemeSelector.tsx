  ...
  return (
    <div className="relative">
      ...
      <select
        ...
        disabled
        className="block w-full appearance-none bg-[var(--bg-interactive)] border border-[var(--border-primary)] text-[var(--text-primary)] py-2 px-3 pr-8 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[var(--accent-primary)] focus:border-[var(--accent-primary)] sm:text-sm cursor-default"
        style={{ 
